		    					...
		    					<div class="account-overview-service-container">
		    						<table class="account-overview-table">
										...
										<tr class="account_overview_row account_overview_row_footer">
									   		<td></td>
									   		<td>
												<button type="button" class="account-overview-button cart-standard-button-paynow account-overview-appt-cancel-button" onclick="tfggPostCartItem('P','<?php echo $details->package_number;?>','1','',true, false);">BUY AGAIN</button>						
											</td>
										</tr>
								...
								<div class="account-overview-service-container">
		    						<table class="account-overview-table">
										...
										<tr class="account_overview_row account_overview_row_footer">
									   		<td></td>
									   		<td>
											   <button type="button" class="account-overview-button cart-standard-button-paynow account-overview-appt-cancel-button" onclick="tfggPostCartItem('M','<?php echo $details->membership_number;?>','1','',true, false);">BUY AGAIN</button>					
											</td>
										</tr>
