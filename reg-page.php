    ...
    function reg_form_display_new(){
        ...
        <hr />
			...
			<div class="registration-container-main">
				...
				<button type="submit" id="registrationSubmitButton" class="account-overview-button account-overview-standard-button" onclick="ValidateNewReg()" disabled> <?php _e('REGISTER YOUR ACCOUNT'); ?></button>
				<div class="account-overview-input-single">
